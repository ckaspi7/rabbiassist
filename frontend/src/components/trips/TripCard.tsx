...
import { MoreVertical, PencilIcon, Trash2Icon, CheckCircle, XCircle, Clock, CircleDot, RotateCcw } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const TripCard = ({ trip }: TripCardProps) => {
  ...
  const renderTripItem = (type: string, icon: string) => {
    ...
    // If no items exist, show dropdown to allow manual status setting
          ...
          <div className="flex items-center ml-auto gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="p-0 h-6 w-6 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                  <MoreVertical className="h-4 w-4" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="bg-white dark:bg-black border-gray-200 dark:border-gray-700">
                <DropdownMenuItem disabled className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                  Set Status
                </DropdownMenuItem>
  ...
  return (
    <div className="p-6 border-b border-gray-100 dark:border-gray-700 last:border-none bg-white dark:bg-black">
      ...
      <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-4">
        {renderTripItem('flight', '✈️')}
        {renderTripItem('hotel', '🏨')}
        {renderTripItem('car', '🚗')}
        {renderTripItem('insurance', '🛡️')}
      </div>
